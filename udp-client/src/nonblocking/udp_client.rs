...
use {
    ...
    xandeum_streamer::nonblocking::sendmmsg::batch_send, std::net::SocketAddr,
    tokio::net::UdpSocket,
};
...
mod tests {
    use {
        super::*,
        xandeum_sdk::packet::{Packet, PACKET_DATA_SIZE},
        xandeum_streamer::nonblocking::recvmmsg::recv_mmsg,
    ...
    async fn test_send_from_addr() {
        ...
        let socket =
            xandeum_net_utils::bind_with_any_port(IpAddr::V4(Ipv4Addr::UNSPECIFIED)).unwrap();
