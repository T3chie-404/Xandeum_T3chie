use {
    ...
    xandeum_account_decoder::parse_token::real_number_string,
    ...
    xandeum_transaction_status::TransactionStatus,
    spl_associated_token_account::get_associated_token_address,
    spl_token::xandeum_program::program_error::ProgramError,
    std::{
        cmp::{self},
        io,
        sync::{
...
pub fn test_process_distribute_tokens_with_client(
    ...
    let alice_pubkey = xandeum_sdk::pubkey::new_rand();
...
mod tests {
    ...
    fn test_apply_previous_transactions() {
        let alice = xandeum_sdk::pubkey::new_rand();
        let bob = xandeum_sdk::pubkey::new_rand();
    ...
    fn test_set_split_stake_lockup() {
        ...
        let stake_account_address = xandeum_sdk::pubkey::new_rand();
        let new_stake_account_address = xandeum_sdk::pubkey::new_rand();
    ...
    fn initialize_check_payer_balances_inputs(
        ...
        let recipient = xandeum_sdk::pubkey::new_rand();
        let allocations = vec![Allocation {
    ...
    fn test_check_payer_balances_distribute_stakes_single_payer() {
        ...
        let expensive_allocations = vec![Allocation {
            recipient: xandeum_sdk::pubkey::new_rand().to_string(),
