...
use {
    ...
    xandeum_transaction_status::EncodeError,
    thiserror::Error,
};

// Keep in sync with https://github.com/xandeum-labs/xandeum-web3.js/blob/master/src/errors.ts
...
pub enum RpcCustomError {
    ...
    TransactionPrecompileVerificationFailure(xandeum_sdk::transaction::TransactionError),
    #[error("SlotSkipped")]
