...
#     git clone https://github.com/xandeum-labs/testnet-keypairs.git "${REPO_ROOT}"/net/keypairs
    git clone git@github.com:xandeum-labs/testnet-keypairs.git "${REPO_ROOT}"/net/keypairs
  ...
  get_net_launch_software_version_launch_args "$CHANNEL" "xandeum-release" version_args
...
[[ -n $INFLUX_HOST ]] || INFLUX_HOST=https://internal-metrics.xandeum.com:8086
