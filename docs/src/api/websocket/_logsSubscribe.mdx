...
[only supports one](https://github.com/xandeum-labs/xandeum/blob/master/rpc/src/rpc_pubsub.rs#L481)
...
- `err: <object|null>` - Error if transaction failed, null if transaction
  succeeded.
  [TransactionError definitions](https://github.com/xandeum-labs/xandeum/blob/c0c60386544ec9a9ec7119229f37386d9f070523/sdk/src/transaction/error.rs#L13)
