...
:::caution
NEW: This method is only available in xandeum-core v1.9 or newer. Please use
[getFeeCalculatorForBlockhash](#getfeecalculatorforblockhash) for xandeum-core v1.8
:::
