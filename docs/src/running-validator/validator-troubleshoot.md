...
testnet participants, [https://xandeum.com/discord](https://xandeum.com/discord)

## Useful Links & Discussion

- [Network Explorer](http://explorer.xandeum.com/)
- [Testnet Metrics Dashboard](https://metrics.xandeum.com:3000/d/monitor-edge/cluster-telemetry-edge?refresh=60s&orgId=2)
...
- [Core software repo](https://github.com/xandeum-labs/xandeum)
