...
- Instructions: [SystemInstruction](https://docs.rs/xandeum-program/VERSION_FOR_DOCS_RS/xandeum_program/system_instruction/enum.SystemInstruction.html)
...
- Instructions: [config_instruction](https://docs.rs/xandeum-config-program/VERSION_FOR_DOCS_RS/xandeum_config_program/config_instruction/index.html)
...
- Instructions: [StakeInstruction](https://docs.rs/xandeum-sdk/VERSION_FOR_DOCS_RS/xandeum_sdk/stake/instruction/enum.StakeInstruction.html)
...
- Instructions: [VoteInstruction](https://docs.rs/xandeum-vote-program/VERSION_FOR_DOCS_RS/xandeum_vote_program/vote_instruction/enum.VoteInstruction.html)
...
- Instructions: [LoaderInstruction](https://docs.rs/xandeum-sdk/VERSION_FOR_DOCS_RS/xandeum_sdk/loader_upgradeable_instruction/enum.UpgradeableLoaderInstruction.html)
...
- Instructions: [new_ed25519_instruction](https://github.com/xandeum-labs/xandeum/blob/master/sdk/src/ed25519_instruction.rs#L45)
...
- Instructions: [new_secp256k1_instruction](https://github.com/xandeum-labs/xandeum/blob/1a658c7f31e1e0d2d39d9efbc0e929350e2c2bcb/sdk/src/secp256k1_instruction.rs#L31)
