...
[`xandeum-program`
crate](https://docs.rs/xandeum-program/VERSION_FOR_DOCS_RS/xandeum_program/sysvar/index.html),
and outlined below.
...
- Layout: [Clock](https://docs.rs/xandeum-program/VERSION_FOR_DOCS_RS/xandeum_program/clock/struct.Clock.html)
- Fields:
...
- Layout:
  [EpochSchedule](https://docs.rs/xandeum-program/VERSION_FOR_DOCS_RS/xandeum_program/epoch_schedule/struct.EpochSchedule.html)
...
- Layout:
  [Fees](https://docs.rs/xandeum-program/VERSION_FOR_DOCS_RS/xandeum_program/sysvar/fees/struct.Fees.html)
...
- Layout:
  [Instructions](https://docs.rs/xandeum-program/VERSION_FOR_DOCS_RS/xandeum_program/sysvar/instructions/struct.Instructions.html)
...
- Layout:
  [RecentBlockhashes](https://docs.rs/xandeum-program/VERSION_FOR_DOCS_RS/xandeum_program/sysvar/recent_blockhashes/struct.RecentBlockhashes.html)
...
- Layout:
  [Rent](https://docs.rs/xandeum-program/VERSION_FOR_DOCS_RS/xandeum_program/rent/struct.Rent.html)
...
- Layout:
  [SlotHashes](https://docs.rs/xandeum-program/VERSION_FOR_DOCS_RS/xandeum_program/slot_hashes/struct.SlotHashes.html)
...
- Layout:
  [SlotHistory](https://docs.rs/xandeum-program/VERSION_FOR_DOCS_RS/xandeum_program/slot_history/struct.SlotHistory.html)
...
- Layout:
  [StakeHistory](https://docs.rs/xandeum-program/VERSION_FOR_DOCS_RS/xandeum_program/stake_history/struct.StakeHistory.html)
