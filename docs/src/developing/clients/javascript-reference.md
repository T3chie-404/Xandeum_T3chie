...
The `@xandeum/web3.js` library is a package that has coverage over the [Solana JSON RPC API](/api).

You can find the full documentation for the `@xandeum/web3.js` library [here](https://xandeum-labs.github.io/xandeum-web3.js/).

## General

### Connection

[Source Documentation](https://xandeum-labs.github.io/xandeum-web3.js/classes/Connection.html)
...
The above example shows only a few of the methods on Connection. Please see the [source generated docs](https://xandeum-labs.github.io/xandeum-web3.js/classes/Connection.html) for the full list.

### Transaction

[SourceDocumentation](https://xandeum-labs.github.io/xandeum-web3.js/classes/Transaction.html)
...
[Source Documentation](https://xandeum-labs.github.io/xandeum-web3.js/classes/Keypair.html)
...
```javascript
const { Keypair } = require("@xandeum/web3.js");
...
[Source Documentation](https://xandeum-labs.github.io/xandeum-web3.js/classes/PublicKey.html)

PublicKey is used throughout `@xandeum/web3.js` in transactions, keypairs, and programs. You require publickey when listing each account in a transaction and as a general identifier on Solana.
...
[SourceDocumentation](https://xandeum-labs.github.io/xandeum-web3.js/classes/SystemProgram.html)
...
[Source Documentation](https://xandeum-labs.github.io/xandeum-web3.js/classes/Secp256k1Program.html)
...
[Source Documentation](https://xandeum-labs.github.io/xandeum-web3.js/classes/Message.html)
...
[SourceDocumentation](https://xandeum-labs.github.io/xandeum-web3.js/classes/Struct.html)
...
import { Struct } from "@xandeum/web3.js";
...
[Source Documentation](https://xandeum-labs.github.io/xandeum-web3.js/classes/Enum.html)
...
```javascript
import { Enum } from "@xandeum/web3.js";
...
[Source Documentation](https://xandeum-labs.github.io/xandeum-web3.js/classes/NonceAccount.html)
...
[SourceDocumentation](https://xandeum-labs.github.io/xandeum-web3.js/classes/VoteAccount.html)
...
[SourceDocumentation](https://xandeum-labs.github.io/xandeum-web3.js/classes/StakeProgram.html)
...
[Source Documentation](https://xandeum-labs.github.io/xandeum-web3.js/classes/Authorized.html)
...
[Source Documentation](https://xandeum-labs.github.io/xandeum-web3.js/classes/Lockup.html)
