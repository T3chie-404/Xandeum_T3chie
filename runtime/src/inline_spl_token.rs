...
use xandeum_sdk::pubkey::{Pubkey, PUBKEY_BYTES};

xandeum_sdk::declare_id!("TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA");

pub(crate) mod program_v3_4_0 {
    xandeum_sdk::declare_id!("NToK4t5AQzxPNpUA84DkxgfXaVDbDQQjpHKCqsbY46B");
}
...
pub mod native_mint {
    xandeum_sdk::declare_id!("So11111111111111111111111111111111111111112");
