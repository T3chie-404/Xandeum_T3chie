...
COMPILER_RT_DIR = $(LOCAL_PATH)../dependencies/platform-tools/rust/lib/rustlib/sbf-xandeum-xandeum/lib
...
ifeq (,$(wildcard $(subst .so,-keypair.json,$1)))
	$(_@)xandeum-keygen new --no-passphrase --silent -o $(subst .so,-keypair.json,$1)
endif
	@echo To deploy this program:
	@echo $$$$ xandeum program deploy $(abspath $1)
endef
