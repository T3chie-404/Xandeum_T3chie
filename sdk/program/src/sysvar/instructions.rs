...
//!
//! [in]: https://docs.xandeum.com/implemented-proposals/instruction_introspection
...
//!
//! [sdoc]: https://docs.xandeum.com/developing/runtime-facilities/sysvars#instructions
//!
//! # Examples
//!
//! For a complete example of how the instructions sysvar is used see the
//! documentation for [`secp256k1_instruction`] in the `xandeum-sdk` crate.
//!
//! [`secp256k1_instruction`]: https://docs.rs/xandeum-sdk/latest/xandeum_sdk/secp256k1_instruction/index.html
