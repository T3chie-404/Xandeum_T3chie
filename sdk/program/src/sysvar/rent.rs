...
//!
//! [rent]: https://docs.xandeum.com/implemented-proposals/rent
//!
...
//!
//! [sdoc]: https://docs.xandeum.com/developing/runtime-facilities/sysvars#rent
//!
//! # Examples
//!
...
//! }
//! #
//! # use xandeum_program::sysvar::SysvarId;
//! # let p = Rent::id();
//! # let l = &mut 1009200;
...
//! # use xandeum_sdk::sysvar::rent::{self, Rent};
//! # use anyhow::Result;
//! #
