...
//!
//! [`Transaction`]: https://docs.rs/xandeum-sdk/latest/xandeum-sdk/transaction/struct.Transaction.html
//!
...
//!
//! [recent blockhash]: https://docs.xandeum.com/developing/programming-model/transactions#recent-blockhash
//!
...
//!
//! Despite living in the `xandeum-program` crate, there is no way to access the
...
///
/// [PoH]: https://docs.xandeum.com/cluster/synchronization
