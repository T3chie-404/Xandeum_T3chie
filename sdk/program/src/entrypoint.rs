...
/// [BPF]: https://docs.xandeum.com/developing/on-chain-programs/overview#berkeley-packet-filter-bpf
///
/// # Cargo features
///
...
macro_rules! custom_heap_default {
    () => {
        #[cfg(all(not(feature = "custom-heap"), target_os = "xandeum"))]
        #[global_allocator]
...
macro_rules! custom_panic_default {
    () => {
        #[cfg(all(not(feature = "custom-panic"), target_os = "xandeum"))]
        #[no_mangle]
        fn custom_panic(info: &core::panic::PanicInfo<'_>) {
