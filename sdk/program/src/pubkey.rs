...
/// defined in `xandeum-program` but in `xandeum-sdk`.
///
...
impl Pubkey {
    ...
    ///
    /// [pda]: https://docs.xandeum.com/developing/programming-model/calling-between-programs#program-derived-addresses
    ///
