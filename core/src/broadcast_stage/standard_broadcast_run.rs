...
impl StandardBroadcastRun {
    ...
    > {
        ...
        let (next_shred_index, next_code_index) = match &self.unfinished_slot {
            ...
            None => {
                ...
                // recreate the slot:
                // https://github.com/xandeum-labs/xandeum/blob/ff68bf6c2/ledger/src/leader_schedule_cache.rs#L142-L146
    ...
    fn process_receive_results(
        ...
        // https://github.com/xandeum-labs/xandeum/blob/53695ecd2/core/src/broadcast_stage/standard_broadcast_run.rs#L334-L339
    ...
    fn insert(
        ...
        // https://github.com/xandeum-labs/xandeum/blob/53695ecd2/core/src/broadcast_stage/standard_broadcast_run.rs#L239-L246
...
mod test {
    ...
    fn entries_to_shreds_max() {
        ...
        let entries = create_ticks(10_000, 1, xandeum_sdk::hash::Hash::default());
