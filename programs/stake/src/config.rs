...
#[deprecated(
    since = "1.8.0",
    note = "Please use `xandeum_sdk::stake::config` or `xandeum_program::stake::config` instead"
)]
pub use xandeum_sdk::stake::config::*;
use {
    bincode::deserialize,
    xandeum_config_program::{create_config_account, get_config_data},
    xandeum_sdk::{
