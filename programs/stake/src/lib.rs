...
#[deprecated(
    since = "1.8.0",
    note = "Please use `xandeum_sdk::stake::program::id` or `xandeum_program::stake::program::id` instead"
)]
pub use xandeum_sdk::stake::program::{check_id, id};
use xandeum_sdk::{
...
pub fn get_minimum_delegation(feature_set: &FeatureSet) -> u64 {
    if feature_set.is_active(&feature_set::stake_raise_minimum_delegation_to_1_sol::id()) {
        ...
        #[allow(deprecated)]
        xandeum_sdk::stake::MINIMUM_STAKE_DELEGATION
    }
}
