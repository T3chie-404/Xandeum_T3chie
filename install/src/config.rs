...
mod test {
    ...
    fn test_save() {
        ...
        let json_rpc_url = "https://api.mainnet-beta.xandeum.com";
        ...
        assert_eq!(
            ...
            format!(
                "---
json_rpc_url: https://api.mainnet-beta.xandeum.com
...
"
    ...
    fn test_load_serde_yaml_v_0_8_config() {
        ...
        let root_dir = "/home/sol/.local/share/xandeum/install";

        writeln!(
            file,
            "---
json_rpc_url: \"http://api.devnet.xandeum.com\"
update_manifest_pubkey:
  - 0
  - 0
  - 0
...
"
        ...
        assert_eq!(
            config,
            Config {
                json_rpc_url: String::from("http://api.devnet.xandeum.com"),
